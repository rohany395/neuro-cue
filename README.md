...
flowchart TD
  ...
  subgraph Vercel["Vercel frontend"]
    ...
    Client["@gradio/client<br/>browser-side public Space access"]
    React --> Client
  end
...
- @gradio/client (public Space access, no browser token)
- Deployed on Vercel
...
- Custom React frontend that calls the public Hugging Face Space
